...
namespace Base_NEAT
{
    class NEATConfig
    {
        ...
        public const float GOAL_SCORE = 400.0f;
        public const float DISTANCE_SCORE = 3.0f;
        public const float KILL_TIME = 7.0f;
        //Game constants
        ...
        //Mutation constants
        public const float MAX_GENETIC_DIFF_SPECIES = 2.0f;
        ...
        public const float DISJOINT_FACTOR = 3.0f;
        public const float MATCHING_FACTOR = 4.0f;
